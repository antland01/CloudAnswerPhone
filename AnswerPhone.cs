...
namespace SimpleAnswerPhone
{
    ...
    public class AnswerPhone(ITwillioService TwillioService, ILogger<AnswerPhone> logger)
    {
        ...
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.Function, "post")] HttpRequestData req)
        {
            ...
            _TwillioService.SendSMS("50 Your UK Number received a Call from " + webhookRequest["From"], Environment.GetEnvironmentVariable("MyNumber", EnvironmentVariableTarget.Process));
